    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
                ...
                <!-- Username or initial (optional) -->
                <span class="ml-2">{{ Auth::user()->username }}</span>
            </a>
            <div class="dropdown-menu dropdown-menu-lg w-50 dropdown-menu-right">
                <!-- Profile link -->
                <a href="" class="dropdown-item text-center">
                    <i class="fas fa-user mr-2"></i> صفحتى الشخصية
                </a>
                <div class="dropdown-divider"></div>
                <!-- Logout link -->
                ...
                <a class="dropdown-item text-center" href=""
                    ...
                    <i class="fas fa-sign-out-alt mr-2"></i> تسجيل الخروج</a>
                </form>
            </div>
        </li>
